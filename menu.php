...
<body>
    ...
    <div class="main-content">
        <div class="table-container">
            <h3>Daftar Menu</h3>
            <form method="POST" action="tambah_menu.php" class="d-flex justify-content-end mb-4">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" href="ubah_menu.php?id=<?php echo $d['id']; ?>">Ubah</a>
                            <a class="btn btn-danger btn-sm" href="hapus_menu.php?id=<?php echo $d['id']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
