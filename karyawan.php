...
try {
    ...
    $karyawanItems = mysqli_fetch_all($result, MYSQLI_ASSOC);
} catch (Exception $e) {
    echo "Gagal mengambil data karyawan: " . $e->getMessage();
    $karyawanItems = [];
}
?>
...
<body>
    ...
    <div class="main-content">
        ...
        <h3>Data Karyawan</h3>
        <form method="POST" action="tambah_karyawan.php" class="d-flex justify-content-end mb-4">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info btn-sm" href="ubah_karyawan.php?id=<?php echo $d['id']; ?>">Ubah</a>
                        <a class="btn btn-danger btn-sm" href="hapus_karyawan.php?id=<?php echo $d['id']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
