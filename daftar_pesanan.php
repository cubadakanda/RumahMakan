...
<body>
    <div class="sidebar">
        <h2>Rm.Padang</h2>
        <a href="pesanan.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
        <a href="pembayaran.php"><i class="fas fa-list"></i> Menu</a>
    ...
    <div class="main-content">
        <div class="table-container">
            ...
            <table border="1" cellpadding="10" cellspacing="0">
                ...
                <tbody>
                    <?php while($row = mysqli_fetch_assoc($paymentData)): ?>
                    <tr>
                        ...
                        <td>
                            <a href="ubah_pembayaran.php?id=<?php echo $row['id_pembayaran']; ?>">Ubah</a> |
                            <a href="hapus_pembayaran.php?id=<?php echo $row['id_pembayaran']; ?>" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                        </td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
