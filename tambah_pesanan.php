...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO pesanan (tanggal_pesanan, menu, jumlah, total_harga, status_pembayaran) VALUES ('$tanggal_pesanan', '$menu', '$jumlah', '$total_harga', '$status_pembayaran')";
    if (mysqli_query($koneksi, $sql)) {
        header('Location: pesanan.php');
        exit;
    } else {
        echo "Gagal menambahkan data pesanan: " . mysqli_error($koneksi);
    }
}
?>
...
<div class="sidebar">
        ...
        <a href="daftar_pesanan.php"><i class="fas fa-tachometer-alt"></i> Daftar Pembayaran</a>
    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <input type="date" name="tanggal_pesanan" required><br><br>
