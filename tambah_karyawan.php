...
<body>
    ...
    <div class="main-content">
        <div class="table-container">
            ...
            <form method="post" action="inputuser_karyawan.php">
                <table class="table">
                    <tr>
                        <td>Nama Lengkap</td>
                    ...
                    <tr>            
                        <td>Posisi</td>
                        <td><input type="text" name="posisi" placeholder="Posisi" required></td>
                    </tr>
                    <tr>            
                        <td>Gender</td>
                    ...
                    <tr>
                        <td>No. Telp</td>
                        <td><input type="text" name="no_telepon" placeholder="Nomor Telepon" required></td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
